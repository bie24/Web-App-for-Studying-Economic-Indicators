...
export default function IndicatorsBar({ country }) {
  ...
  //   const [previousIndicator, setPreviousIndicator] = useState(null);
  ...
  //     setPreviousIndicator(selectedIndicators[0]); // Salvați indicatorul anterior în starea previousIndicator
  //     setSelectedIndicators([indicator]);
  //   };
  //   // useEffect(() => {
  ...
  //   //     setSelectedIndicators((prevSelectedIndicators) =>
  //   //       prevSelectedIndicators.filter(
  //   //         (indicator) => indicator === previousIndicator
  //   //       )
  //   //     );
  //   //   }
  //   // }, [previousIndicator]); // Efectul se activează atunci când indicatorul anterior se schimbă
  //   useEffect(() => {
  //     if (previousIndicator && selectedIndicators.length > 1) {
  //       setSelectedIndicators([
  //         selectedIndicators[selectedIndicators.length - 1],
  //       ]);
  //     }
  //   }, [previousIndicator, selectedIndicators]);
  ...
  //               const selectedIndicator = country.ani
  //                 .map((item) => ({
  //                   an: item.an,
  //                   indicatori: item.indicatori,
  //                 }))
  //                 .filter((item) =>
  //                   item.indicatori.some((i) => i.nume === indicatorName)
  //                 );
